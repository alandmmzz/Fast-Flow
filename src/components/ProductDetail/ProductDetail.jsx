...
export default function ProductDetail({ product }) {
    ...
    return (
        <section id="product-detail" className="px-4 py-4 text-gray-800 dark:text-gray-100">
            {/* Imagen principal */}
            <div
                className="main-image w-full h-[220px] sm:h-[280px] bg-gray-100 dark:bg-gray-800 rounded-xl overflow-hidden flex items-center justify-center mb-3 cursor-pointer"
            ...
            {/* Nombre del producto */}
            <h2 className="product-detail-name text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold font-semibold mb-3">{product.name}</h2>
